...
import projectexamen.spring.campconnect.Entity.*;
import projectexamen.spring.campconnect.Repository.*;
...
public class PatnershipServiceImp implements IPatnershipService {
    ...
    private CampingsRepository campingsRepository;
    private PasswordEncoder passwordEncoder;

    @Override
    public List<PartnerUserSummaryDTO> getPartnerUsers() {
    ...
    @Override
    @Transactional
    public PartnerUserSummaryDTO createPartnerUser(PartnerUserWriteDTO dto) {
    ...
    @Override
    @Transactional
    public PartnerUserSummaryDTO updatePartnerUser(Long id, PartnerUserWriteDTO dto) {
    ...
    public void deletePartnerUser(Long id) {
        ...
        for (campings c : campingsRepository.findAll()) {
            boolean removed = c.getPartnerLinks().removeIf(partner -> partner.getIdUser().equals(id));
            if (removed) {
                campingsRepository.save(c);
            }
        }
        userRepository.delete(u);
    }

    private PartnerUserSummaryDTO toPartnerSummary(User u) {
        PartnerUserSummaryDTO d = new PartnerUserSummaryDTO();
        d.setId(u.getIdUser());
    ...
    public List<CampingPartnershipDTO> getPartnershipCampings() {
        return campingsRepository.findAll().stream()
                .map(this::toCampingPartnershipDTO)
                .collect(Collectors.toList());
    }

    private CampingPartnershipDTO toCampingPartnershipDTO(campings c) {
        CampingPartnershipDTO d = new CampingPartnershipDTO();
    ...
    @Override
    @Transactional
    public CampingPartnershipDTO createCamping(CampingPartnershipDTO dto) {
        ...
        return toCampingPartnershipDTO(campingsRepository.save(c));
    }

    @Override
    @Transactional
    public CampingPartnershipDTO updateCamping(Long id, CampingPartnershipDTO dto) {
        campings c = campingsRepository.findById(id)
    ...
    private ContratDTO getContratDTO(ContratDTO dto, Contrat contrat) {
    ...
    @Override
    public ContratDTO updateContrat(Long id, ContratDTO dto) {
        Contrat contrat = contratRepository.findById(id)
                .orElseThrow(() -> new RuntimeException("Contrat not found with id: " + id));
        return getContratDTO(dto, contrat);
    }
    ...
    @Override
    public List<PartnerInterviewDTO> getAllInterviews() {
    ...
    @Override
    public PartnerInterviewDTO getInterviewById(Long id) {
    ...
    @Override
    public PartnerInterviewDTO createInterview(PartnerInterviewDTO dto) {
    ...
    @Override
    public PartnerInterviewDTO updateInterview(Long id, PartnerInterviewDTO dto) {
        PartnerInterview pi = interviewRepository.findById(id)
                .orElseThrow(() -> new RuntimeException("Interview not found with id: " + id));
        pi.setInterviewDate(dto.getInterviewDate());
        pi.setGlobalScore(dto.getGlobalScore());
    ...
    @Override
    public List<InterviewMeetingDTO> getAllMeetings() {
    ...
    @Override
    public InterviewMeetingDTO getMeetingById(Long id) {
    ...
    @Override
    public InterviewMeetingDTO createMeeting(InterviewMeetingDTO dto) {
    ...
    @Override
    public InterviewMeetingDTO updateMeeting(Long id, InterviewMeetingDTO dto) {
        InterviewMeeting m = meetingRepository.findById(id)
                .orElseThrow(() -> new RuntimeException("Meeting not found with id: " + id));
        m.setMeetingDate(dto.getMeetingDate());
        m.setStartTime(dto.getStartTime());
    ...
    @Override
    public List<PartnerQuizDTO> getAllQuizzes() {
    ...
    @Override
    public PartnerQuizDTO getQuizById(Long id) {
    ...
    @Override
    public PartnerQuizDTO createQuiz(PartnerQuizDTO dto) {
    ...
    @Override
    public PartnerQuizDTO updateQuiz(Long id, PartnerQuizDTO dto) {
        PartnerQuiz q = quizRepository.findById(id)
                .orElseThrow(() -> new RuntimeException("Quiz not found with id: " + id));
        q.setTitle(dto.getTitle());
        q.setMaxScore(dto.getMaxScore());
    ...
    @Override
    public List<PartnerQuestionDTO> getAllQuestions() {
    ...
    @Override
    public PartnerQuestionDTO getQuestionById(Long id) {
    ...
    @Override
    public PartnerQuestionDTO createQuestion(PartnerQuestionDTO dto) {
    ...
    @Override
    public PartnerQuestionDTO updateQuestion(Long id, PartnerQuestionDTO dto) {
        PartnerQuestion pq = questionRepository.findById(id)
                .orElseThrow(() -> new RuntimeException("Question not found with id: " + id));
        pq.setLabel(dto.getLabel());
        pq.setType(QuestionType.valueOf(dto.getType()));
    ...
    @Override
    public List<QuizReponsesDTO> getAllReponses() {
    ...
    @Override
    public QuizReponsesDTO getReponseById(Long id) {
    ...
    @Override
    public QuizReponsesDTO createReponse(QuizReponsesDTO dto) {
    ...
    @Override
    public QuizReponsesDTO updateReponse(Long id, QuizReponsesDTO dto) {
        Quizreponses r = reponsesRepository.findById(id)
                .orElseThrow(() -> new RuntimeException("Reponse not found with id: " + id));
        r.setValue(dto.getValue());
        r.setGrade(dto.getGrade());
    ...
    private ContratDTO toContratDTO(Contrat c) {
    ...
    private PartnerInterviewDTO toInterviewDTO(PartnerInterview pi) {
        return new PartnerInterviewDTO(
                pi.getInterviewId(),
                pi.getInterviewDate(),
                pi.getGlobalScore(),
    ...
    private InterviewMeetingDTO toMeetingDTO(InterviewMeeting m) {
        return new InterviewMeetingDTO(
                m.getMeetingId(),
                m.getMeetingDate(),
                m.getStartTime(),
                m.getEndTime(),
    ...
    private PartnerQuizDTO toQuizDTO(PartnerQuiz q) {
        return new PartnerQuizDTO(
                q.getQuizId(),
                q.getTitle(),
                q.getMaxScore(),
    ...
    private PartnerQuestionDTO toQuestionDTO(PartnerQuestion pq) {
        return new PartnerQuestionDTO(
                pq.getQuestionId(),
                pq.getLabel(),
    ...
    private QuizReponsesDTO toReponsesDTO(Quizreponses r) {
        return new QuizReponsesDTO(
                r.getResponseId(),
                r.getValue(),
                r.getGrade(),

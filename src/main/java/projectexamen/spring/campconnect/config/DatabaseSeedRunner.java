package projectexamen.spring.campconnect.config;
...
public class DatabaseSeedRunner implements ApplicationRunner {
    ...
    private final CampingsRepository campingsRepository;
    ...
    public void run(ApplicationArguments args) {
        ...
        campings cPins = camping("Camping Les Pins Bleus", "45 route forestière", "Arcachon", "33120", 140);
        campings cLac = camping("Lac Tranquille", "Chemin du lac 12", "Annecy", "74000", 95);
        campings cDune = camping("Les Dunes d’Argent", "Avenue de la plage", "Sète", "34200", 200);
        campings cVerdon = camping("Verdon Nature", "RN 85 km 12", "Moustiers-Sainte-Marie", "04360", 110);
        campings cBretagne = camping("Armor Bretagne", "Lieu-dit Ker Garen", "Carnac", "56340", 175);
        campings cVosges = camping("Sapins des Vosges", "18 rue des Crêtes", "Gérardmer", "88400", 88);
    ...
    private static campings camping(String name, String address, String city, String postal, int cap) {
    ...
    private static void link(campings c, User... ps) {
        for (User p : ps) {
